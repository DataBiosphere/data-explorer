    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('enable_search_values')) {
                obj['enable_search_values'] = ApiClient.convertToType(data['enable_search_values'], 'Boolean');
            }
            if (data.hasOwnProperty('show_viz_toggle')) {
                obj['show_viz_toggle'] = ApiClient.convertToType(data['show_viz_toggle'], 'Boolean');
            }
        }
        return obj;
    }

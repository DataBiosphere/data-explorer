...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataExplorerService.FacetsResponse();
  });
  ...
  describe('FacetsResponse', function() {
    it('should create an instance of FacetsResponse', function() {
      // uncomment below and update the code to test FacetsResponse

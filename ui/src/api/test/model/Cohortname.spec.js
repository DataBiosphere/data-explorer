...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DataExplorerService.Cohortname();
  });
  ...
  describe("Cohortname", function() {
    it("should create an instance of Cohortname", function() {
      // uncomment below and update the code to test Cohortname
      //var instane = new DataExplorerService.Cohortname();
      //expect(instance).to.be.a(DataExplorerService.Cohortname);
    });

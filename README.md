...
* `mkdir api/dataset-config && cp test/* api/dataset-config/`
...
* Create `api/dataset-config` and copy over config files from above step.
  See [example](https://github.com/DataBiosphere/data-explorer-indexers/blob/master/bigquery/dataset-config/platinum_genomes)
  here. Specifically:
